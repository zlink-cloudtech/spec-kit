...
- update command templates to include prerequisite checks and refine skill identification process (#31)
...
- add generation of Claude Code native subagent files and update AGENTS.md

### Fixed

- feature branch always start 1; remove something of not need
...
- add system-map.md validation to /speckit.analyze (#19)

## [2.9.4] - 2026-03-09

### Changed

- remove internal ticket numbers from code comments (#18)

### Documentation

- Add converge phase to README.md and README-CN.md (#17)

## [2.9.3] - 2026-03-09

### Changed

- remove skill speckit-vibe

## [2.9.1] - 2026-03-09

### Fixed

- no reference specs/ in tasks
...
- update tag retrieval method to ensure all branches are considered
