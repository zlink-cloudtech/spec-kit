...
<p align="center">
    ...
    <a href="https://github.com/zlink-cloudtech/spec-kit/stargazers"><img src="https://img.shields.io/github/stars/zlinkcloudtech/spec-kit?style=social" alt="GitHub stars"/></a>
    <a href="https://github.com/zlink-cloudtech/spec-kit/blob/main/LICENSE"><img src="https://img.shields.io/github/license/zlinkcloudtech/spec-kit" alt="License"/></a>
...
| `/speckit.doc-update`  | Manage project documentation in sync with `memory/system-map.md` — supports update, add, delete, deprecate, rename/move, merge, and reposition (standalone, lifecycle-independent) |
...
For support, please open a [GitHub issue](https://github.com/zlink-cloudtech/spec-kit/issues/new). We welcome bug reports, feature requests, and questions about using Spec-Driven Development.
